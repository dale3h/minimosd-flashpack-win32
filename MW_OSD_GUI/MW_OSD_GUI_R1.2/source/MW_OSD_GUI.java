...
//    System.out.println("Loc: "+i+ " Val: "+ int(confItem[i].value()) );
     ...
     int clayout=PApplet.parseInt(confItem[GetSetting("S_HUD")].value()); 
     for(int i = 0; i < (CONFIGITEMS16); i++){
       serialize8(PApplet.parseInt(ConfigLayout[0][i]&0xFF));
       serialize8(PApplet.parseInt(ConfigLayout[0][i]>>8));
     }
     for(int i = 0; i < (CONFIGITEMS16); i++){
       serialize8(PApplet.parseInt(ConfigLayout[1][i]&0xFF));
       serialize8(PApplet.parseInt(ConfigLayout[1][i]>>8));
     }
